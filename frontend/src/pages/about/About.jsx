      ...
      <div className="pt-20">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="w-full space-y-4">
            ...
            /> */}
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d13281.833414586055!2d73.07594429999999!3d33.671193949999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1724354725158!5m2!1sen!2s"
          ...
          <div className="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
            <div className="space-y-6">
              ...
              <button
                type="button"
                className="rounded-md w-full bg-primary px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-primary/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Join Now
              </button>
            </div>
